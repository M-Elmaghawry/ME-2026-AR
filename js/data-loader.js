...
async function renderServices() {
    ...
    if (serviceSelect) {
        ...
        if (defaultOption) {
            ...
            newDefaultOption.textContent = 'اختر الخدمة';
                ...
                <div>
                    ...
                    <div class="slider-meta">
                        <div class="slider-meta-item">
                            <span class="slider-meta-label">العميل</span>
                            <span class="slider-meta-value">${project.client || 'سري'}</span>
                        </div>
                        <div class="slider-meta-item">
                            <span class="slider-meta-label">العام</span>
                            <span class="slider-meta-value">${project.year || 'حديث'}</span>
                        </div>
                    </div>
                </div>
            </div>
